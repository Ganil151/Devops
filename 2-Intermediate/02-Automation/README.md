...
1.  **[01-Shell-Scripting-Basics](./01-Shell-Scripting-Basics/Shell%20Scripting%20Basics-The%20DevOps%20Glue.md)**: Variables, Loops, and the native language of the server.
2.  **[02-Advanced-Bash-Automation](./02-Advanced-Bash-Automation/Advanced%20Bash%20Automation.md)**: Error handling, `jq`, and remote execution.
3.  **[03-Python-for-DevOps](./03-Python-for-DevOps/Python%20for%20DevOps.md)**: Cloud SDKs (Boto3), APIs, and modular automation code.
4.  **[04-Automation-Best-Practices](./04-Automation-Best-Practices/Automation%20Best%20Practices.md)**: Logging, Idempotency, and the "Fail Fast" mindset.
...
6.  **[06-Real-Life-Scenarios](./06-Real-Life-Scenarios/Automation%20Real-Life%20Scenarios.md)**: Practical troubleshootng and governance automation.
...
- **Parameterization**: Never hardcode values; use environment variables or arguments.
- **Documentation**: Comment your code for future maintainability.
- **Modularization**: Break large scripts into smaller, reusable functions.

---

## ✅ Knowledge Check
- [x] Understand exit codes (Success vs. Failure)
- [x] Write a Bash script with loops and conditionals
- [x] Parse JSON data using `jq`
- [x] Use Python to interact with a Cloud API (e.g., Boto3)
- [x] Implement error handling and logging in your scripts
