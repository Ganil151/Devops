...
- [Providers](../../01-Fundamentals/06-Providers/Providers.md) - Provider configuration
...
### Command References
- [Init Command](../../01-Fundamentals/02-Commands/01-Init.md) - Initialize working directory
- [Plan Command](../../01-Fundamentals/02-Commands/03-Plan.md) - Create execution plan
- [Apply Command](../../01-Fundamentals/02-Commands/04-Apply.md) - Apply changes
- [Output Command](../../01-Fundamentals/02-Commands/11-Output.md) - View outputs
- [Validate Command](../../01-Fundamentals/02-Commands/02-Validate.md) - Validate configuration
- [Console Command](../../01-Fundamentals/02-Commands/14-Console.md) - Interactive console

### Related Labs
- [Day 5: Project Structure](../05-Day/README.md) - File organization
- [Day 4: Remote State](../04-Day/README.md) - Backend configuration
- [Day 6: Functions](../06-Day/README.md) - Built-in functions
- [Day 8: Modules](../08-Day/README.md) - Module development
