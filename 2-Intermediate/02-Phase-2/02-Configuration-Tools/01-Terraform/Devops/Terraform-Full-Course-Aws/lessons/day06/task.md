...
- [ ] Watch the Day 06 video and take notes
- [ ] Reorganize your previous Terraform configuration into separate files (backend.tf, provider.tf, variables.tf, locals.tf, main.tf, outputs.tf)
- [ ] Write a short blog (500-800 words) about what you learned
  - Include your own diagrams and code examples
  - Add screenshots of your organized file structure and terraform plan output
  - Embed the video
