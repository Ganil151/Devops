...
- [ ] Watch the Day 13 video and take notes
- [ ] Complete the data sources demo (create shared VPC, use data sources, launch EC2)
- [ ] Write a short blog (500-800 words) about what you learned
  - Include your own diagrams and code examples
  - Add screenshots of your Terraform code and AWS Console
  - Document the difference between resources and data sources
  - Embed the video
