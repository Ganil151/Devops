# Networking & DNS - Intermediate (Route 53)

Practical implementation of DNS management and health monitoring.

## Guides

### [Hands-on Route 53 Guide (Console & CLI)](route53-hands-on.md)
Step-by-step instructions for:
- Creating Public Hosted Zones.
- Managing records (A and Alias).
- Setting up endpoint Health Checks.
