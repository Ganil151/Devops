# File Storage - Intermediate

Practical implementation of shared file systems for distributed workloads.

## Guides

### [Hands-on EFS Guide (Console & CLI)](efs-hands-on.md)
Step-by-step instructions for:
- Creating an EFS file system.
- Configuring network access and security groups.
- Mounting EFS on EC2 using `amazon-efs-utils`.
