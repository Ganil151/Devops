# Governance & Compliance - Intermediate

Automate configuration monitoring and ensure resource compliance at scale.

## Guides

### [AWS Config & Governance Guide](aws-config-governance.md)
