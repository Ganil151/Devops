...
| :--- | :--- | :--- | :--- |
| **01** | [**logic_and_arrays.sh**](../01-Shell-Fundamentals/02-Intermediate-Logic/logic_and_arrays.sh) | Intermediate Logic | Associative Arrays, Regex Conditionals (`[[ =~ ]]`). |
| **02** | [**functions_modularity.sh**](../../03-Part-3-The-Building-Blocks/01-Production-Scripting-Patterns/03-Advanced-Functions-and-Modularity/functions_modularity.sh) | Modularity | Local variables, return codes, library-style logic. |
