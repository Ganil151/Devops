...
3.  **[GitLab CI/CD](../../../README.md)**: GitLab pipelines and CI/CD (see Repository Management).
...
### GitLab CI
Highly integrated, modern, and container-native CI/CD. See **[Repository Management - GitLab](../../../README.md)** for complete coverage.
