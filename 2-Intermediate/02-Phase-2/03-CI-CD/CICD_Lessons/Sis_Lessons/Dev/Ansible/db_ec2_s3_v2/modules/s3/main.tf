# S3 Bucket for Jenkins State
resource "aws_s3_bucket" "jenkins-register" {
  bucket = "project-register" 
  

  tags = {
    Name = "Jenkins Register Bucket"
  }
}

# Enable Versioning
resource "aws_s3_bucket_versioning" "versioning" {
  bucket = aws_s3_bucket.jenkins-register.id
    ...
    Statement = [
      {
        ...
        Resource = [
          aws_s3_bucket.jenkins-register.arn,
          "${aws_s3_bucket.jenkins-register.arn}/*"
        ]
      },
      {
