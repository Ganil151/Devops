...
- **[02-Subnetting-and-CIDR](./02-Subnetting-and-CIDR/)**: Layer 2 segmentation.
- **[03-Internet-and-NAT-Gateways](./03-Internet-and-NAT-Gateways/)**: OSPF, BGP, Static routing.
- **[04-Routing-and-Route-Tables](./04-Routing-and-Route-Tables/)**: Firewalls, VPNs, Security Groups.
- **[05-Network-Security-NACLs-SGs](./05-Network-Security-NACLs-SGs/)**: Remote access and Site-to-Site.
