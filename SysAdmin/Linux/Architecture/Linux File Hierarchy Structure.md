...
**2. /bin :** 
Essential command binaries that need to be available in single-user mode; for all users, e.g., <font color="#ff0000">cat</font>,<font color="#ff0000"> ls</font>, <font color="#ff0000">cp</font>. 
- Contains binary executables.
- Common Linux commands you need to use in single-user modes are located under this directory.
- Commands used by all the users of the system are located here e.g. <font color="#ff0000">ps</font>,<font color="#ff0000"> ls</font>, <font color="#ff0000">ping</font>, <font color="#ff0000">grep</font>, <font color="#ff0000">cp</font> 

![bin-linux-directory](https://media.geeksforgeeks.org/wp-content/uploads/20230516110537/153.webp)
###  bin-linux-directory
**3. /boot :**
 Boot loader files, e.g., kernels, initrd.   
- Kernel initrd, vmlinux, grub files are located under<font color="#ff0000"> /boot</font>
