...
- [x] My reservation (static)
- [x] My properties (static)
- [x] Inbox page (static)
- [x] Detail page for chat (static)
- [x] User menu popup
- [x] Create re-useable model window
- [x] Log in model (remember error codes)
- [x] Sign up model (remember error codes)

### Step 2
- [x] Set up docker for django with postgresql, etc
	- [x] Install DRF, cars headers, etc
