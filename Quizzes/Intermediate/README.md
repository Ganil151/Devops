...
**Study Resource**: [Kubernetes Modules](../../2-Intermediate/03-Phase-3/06-Container-Orchestration/README.md)
...
**Study Resource**: [Helm Packaging](../../2-Intermediate/02-Phase-2/05-Configuration-Tools/04-Helm/README.md)
...
**Study Resource**: [Ansible Automation](../../2-Intermediate/02-Phase-2/03-Automation/05-Ansible/README.md)
...
**Study Resource**: [Terraform IaC](../../2-Intermediate/02-Phase-2/05-Configuration-Tools/01-Terraform/README.md)
...
**Study Resource**: [Intermediate CI/CD](../../2-Intermediate/02-Phase-2/09-CI-CD/README.md)
...
**Study Resource**: [VPC Networking](../../2-Intermediate/01-Phase-1/01-Networking/README.md)
...
**Study Resource**: [Cloud Foundations](../../1-Beginner/01-Phase-1/13-Cloud-Foundations/README.md)
...
**Study Resource**: [Chef Automation](../../2-Intermediate/02-Phase-2/05-Configuration-Tools/03-Chef/README.md) & [Automation Foundations](../../2-Intermediate/02-Phase-2/03-Automation/README.md)
