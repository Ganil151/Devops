...
## 🛠️ The DevOps Keyword Matrix

Use these keywords to pass automated filters:

- **Automation**: IaC, Terraform, Ansible, Pulumi.
- **Orchestration**: Kubernetes, Helm, EKS, GKE, ArgoCD.
- **Delivery**: Jenkins, GitHub Actions, GitLab CI, CI/CD Pipelines.
- **Observability**: Prometheus, Grafana, ELK, Jaeger, OTel.
- **Security**: DevSecOps, Trivy, SonarQube, Vault.
...
1. **Q: Why should you use "Action Verbs" on your resume?**
   - *A: Action verbs like "Automated," "Optimized," and "Architected" demonstrate impact and ownership rather than just passive participation.*
2. **Q: How do you quantify results for a DevOps project?**
...
**Challenges**: [technical_scenarios.md](../../07-Quizzes/01-Beginner/Networking-Scenarios.md)
