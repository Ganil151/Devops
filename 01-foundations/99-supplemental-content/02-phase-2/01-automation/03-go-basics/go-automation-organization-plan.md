...
```
Devops/
├── 01-Beginner/02-Phase-2/02-Automation/03-Go-Basics/
│   ├── 01-Go-Fundamentals/
...
│   └── 17-First-CLI-Tool/
│
├── 02-Intermediate/02-Phase-2/02-Automation/03-Go-Automation/
...
│   └── 18-Testing-Advanced/
│
└── 03-Advanced/02-Phase-2/02-Automation/03-Go-Advanced/
