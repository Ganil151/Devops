...
The successor to 10Base-T, offering 10x the speed (100 Mbps) over the same twisted pair infrastructure (Cat5+ recommended).

100BASE-T is the IEEE standard that defines the requirement for sending information at 100 Mbps on unshielded twisted-pair cabling, and defines various aspects of running base-band Ethernet on this cabling.
