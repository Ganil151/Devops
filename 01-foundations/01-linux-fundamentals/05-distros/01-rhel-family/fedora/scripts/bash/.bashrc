...
# --- 00b. Debug Toggle ---
: "${DEVOPS_DEBUG:=0}"
__debug() { [[ "$DEVOPS_DEBUG" -eq 1 ]] && echo "[DEBUG] $*" >&2; }
...
__bira_box_prompt() {
  ...
  local line1="${_SYM_TL}${_SEP} ${_NO_FG}\u@\h${_NO_RESET} ${_NO_GREEN}${short_path}${_NO_RESET}${git_info}${ctx_info}${aws_info}${exec_time}"
