...
1. **[🔴 01-Dynamic-Secrets-Generation](./01-Dynamic-Secrets-Generation/)**
   - Configuring the Database Secret Engine.
   - On-the-fly creation of temporary SQL users.
2. **[🔴 02-Vault-Agent-Auto-Auth](./02-Vault-Agent-Auto-Auth/)**
...
---
**Next Step**: Start with [Dynamic Secrets Generation](./01-Dynamic-Secrets-Generation/) 🚀
