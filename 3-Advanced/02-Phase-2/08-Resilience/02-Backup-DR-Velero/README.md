...
1. **[🔴 01-Stateful-Backup-Logic](./01-Stateful-Backup-Logic/)**
   - Volume Snapshot Locations (VSL) vs. Backup Storage Locations (BSL).
   - Hooking into databases (Pre-backup fs-freeze).
2. **[🔴 02-Disaster-Recovery-Testing](./02-Disaster-Recovery-Testing/)**
...
---
**Next Step**: Start with [Stateful Backup Logic](./01-Stateful-Backup-Logic/) 🚀
