...
1. **[🔴 01-PagerDuty-API-Automation](./01-PagerDuty-API-Automation/)**
   - Managing API Tokens and Routing Keys.
   - Sending custom event payloads to PagerDuty.
2. **[🔴 02-Lambda-Auto-Remediation](./02-Lambda-Auto-Remediation/)**
...
---
**Next Step**: Start with [PagerDuty API Automation](./01-PagerDuty-API-Automation/) 🚀
