...
1. **[🔴 01-Image-Vulnerability-Scanning](./01-Image-Vulnerability-Scanning/)**
   - High vs. Critical CVE filtering strategies.
   - Base image selection and optimization.
2. **[🔴 02-Secret-Leakage-Prevention](./02-Secret-Leakage-Prevention/)**
...
---
**Next Step**: Start with [Image Vulnerability Scanning](./01-Image-Vulnerability-Scanning/) 🚀
