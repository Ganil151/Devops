...
1. **[🔴 01-Custodian-Policy-Language](./01-Custodian-Policy-Language/)**
   - Writing your first policy: "Finding Orphaned Volumes".
   - Using the `custodian` CLI for dry-runs.
2. **[🔴 02-Real-time-Remediation](./02-Real-time-Remediation/)**
...
---
**Next Step**: Start with [Custodian Policy Language](./01-Custodian-Policy-Language/) 🚀
