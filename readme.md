...
![DevOps Continuous Learning](./assets/images/devops-learning-path.png)
...
graph TD
    ...
    classDef career fill:#fff3e0,stroke:#ef6c00;
    classDef interview fill:#f3e5f5,stroke:#7b1fa2;

    F[<b>Tier 1: Foundation</b><br/>Linux, Networking, Git, Windows]:::foundation --> C[<b>Tier 2: Core Engineering</b><br/>AWS, Terraform, Python, K8s]:::core
    C --> I[<b>Tier 3: Career Strategy</b><br/>Branding, Resume, Soft Skills]:::career
    C --> R[<b>Tier 4: Interview Readiness</b><br/>Technical, Behavioral, Coding]:::interview
```
