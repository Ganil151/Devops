...
- have to give the computer a new name other than what amazon assigned
- after go to server manager 
- click on Active Directory Domain Services and .NET Framework 
![[ActiveDirctory.png]]