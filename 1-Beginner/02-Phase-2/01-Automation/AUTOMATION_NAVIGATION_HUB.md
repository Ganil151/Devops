...
## 📚 Welcome!
This is your central navigation hub for **core automation modules** across three industry-standard languages. Everything is organized, documented, and ready for your learning journey.
...
#### Shell Scripting
```
cd 1-Beginner/02-Phase-2/01-Automation/01-Shell-Scripting/
```
- ✅ **01-17** - [Beginner Phase Complete](./01-Shell-Scripting/)

#### Python Automation
```
cd 1-Beginner/02-Phase-2/01-Automation/02-Python-Basics/
```
...
#### Go Automation
```
cd 1-Beginner/02-Phase-2/01-Automation/03-Go-Basics/
```
...
```mermaid
graph LR
    A[Core Automation Skills] --> B[Shell: 24 Modules]
    A --> C[Python: 18 Modules]
    A --> D[Go: 18 Modules]
    ...
    style A fill:#6c5ce7,stroke:#333,stroke-width:3px,color:#fff
...
| Language | Modules | Complete | Estimated Hours |
|----------|--------|----------|-----------------|
| **Shell** | 24 | 9 (37%) | 105-140h |
| **Python** | 18 | 1 (5%) | 100-150h |
| **Go** | 18 | 0 (0%) | 100-150h |
| **TOTAL** | **60** | **10 (16%)** | **305-440h** |
...
2. Python Basics (add Python skills)
3. Go Basics (exposure to compiled language)
...
gantt
    ...
    section Learning
    Shell Basics           :2026-01-10, 60d
    Python Basics          :2026-03-11, 60d
    Build Portfolio        :2026-05-10, 45d
    section Job Search
    Apply to Jobs          :2026-06-24, 30d
    Interview Prep         :2026-06-24, 45d
    section Employment
    Job Offers             :2026-08-08, 14d
    Start Career           :milestone, 2026-08-22, 1d
```
### Salary Expectations
