...
curl -X PUT \
    ...
    "https://management.azure.com/subscriptions/{subscription-id}/resourceGroups/DevOpsRG/providers/Microsoft.Storage/storageAccounts/devopsstorage?api-version=2021-04-01"
```
